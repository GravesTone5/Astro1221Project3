...
>> Astropy: For this one, you will see that you need it for opening the fits file in the first place. You will need files of both the bands, in order to get the PSF fittings and the color-magnitude diagram. This is optional (though I find it cool) but you can also open the total (the original image given) fits file to see the original image with both the bands on it.
